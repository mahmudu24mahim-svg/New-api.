...
res.send(`
  ...
  <a>Developer Unknown</a> | <a href="/user">User Panel</a>  
  `);  
});  // =================================================
// ================= ADMIN PANEL ===================
// =================================================
...
<body>  <div class="box">  
<h2>🔐 Admin Login</h2>  <input id="u" placeholder="User">  
<input id="p" placeholder="Password">  <button onclick="login()">Login</button>
